...
class ExampleInstrumentedTest {
    ...
    val activityScenario: ActivityScenario<MainActivity> =
        ...
        onView(withId(R.id.button_second)).check(matches(withText("Proxima")))

        onView(withId(R.id.buttonCadastro)).check(matches(isDisplayed()))
        onView(withId(R.id.buttonCadastro)).check(matches(withText("Cadastro")))
        ...
        onView(withId(R.id.tvNomeCad)).perform(typeText("Thiago"), ViewActions.closeSoftKeyboard())
        onView(withId(R.id.tvNomeCad)).check(matches(withText("Thiago")))

        onView(withId(R.id.tvEmailCad)).perform(typeText("Thiago@gmail.com"), ViewActions.closeSoftKeyboard())
        onView(withId(R.id.tvEmailCad)).check(matches(withText("Thiago@gmail.com")))

        onView(withId(R.id.tvSenhaCad)).perform(typeText("123456789"), ViewActions.closeSoftKeyboard())
        onView(withId(R.id.tvSenhaCad)).check(matches(withText("123456789")))

        onView(withId(R.id.btnCadastrarCad)).check(matches(isDisplayed()))
        onView(withId(R.id.btnCadastrarCad)).check(matches(withText("Cadastrar")))
        ...
        onView(withId(R.id.nome_edt)).check(matches(isDisplayed()))
        onView(withId(R.id.nome_edt)).perform(typeText("Thiago@gmail.com"), ViewActions.closeSoftKeyboard())
        onView(withId(R.id.nome_edt)).check(matches(withText("Thiago@gmail.com")))

        onView(withId(R.id.sobrenome_edt)).check(matches(isDisplayed()))
        onView(withId(R.id.sobrenome_edt)).perform(typeText("123456789"), ViewActions.closeSoftKeyboard())
        ...
        onView(withId(R.id.TextoDigitado)).perform(typeText("The Isle e um jogo"))
        ...
        onView(withId(R.id.TextoDigitado)).check(matches(withText("The Isle e um jogo")))
        ...
        onView(withId(R.id.TextoDigitado)).check(matches(withText("")))
